<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('rolusuario') }}
            {{ Form::text('rolusuario', $usuario->rolusuario, ['class' => 'form-control' . ($errors->has('rolusuario') ? ' is-invalid' : ''), 'placeholder' => 'Rolusuario']) }}
            {!! $errors->first('rolusuario', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('telefono') }}
